...
<br />Similarity heatmaps of `lincka` on WSJ (left) and TIMIT (right). Similarity values are annotated.
<p float="left">
  <img src="./Figs/lincka_wsj.png" width="45%" />
  <img src="./Figs/lincka_timit.png" width="45%" /> 
</p>

<br />Similarity heatmaps of `svcca` on WSJ (left) and TIMIT (right). Similarity values are annotated.
<p float="left">
  <img src="./Figs/svcca_wsj.png" width="45%" />
  <img src="./Figs/svcca_timit.png" width="45%" /> 
</p>
